...
export default function Settings() {
    ...
    return (
        <div className='settings-component'>
            ...
            <div className='field'>
                <label>
                    <input type='checkbox' checked={settings.allowLikes} onChange={handleAllowLikesClick} />
                    Allow Likes
                </label>
            </div>
            <div className='field'>
                <label>
                    <input type='checkbox' checked={settings.allowDislikes} onChange={handleAllowDislikesClick} />
                    Allow Dislikes
                </label>
            </div>
        </div>
